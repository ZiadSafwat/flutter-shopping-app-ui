...
/// A class that contains all theme configurations for the mobile e-commerce application.
class AppTheme {
  AppTheme._();

  // Adaptive Commerce Palette - Colors optimized for product photography and trust-building
  static const Color primaryLight =
      Color(0xFF2563EB); // Trust-building blue for purchase actions
  static const Color secondaryLight =
      Color(0xFF64748B); // Supporting text and secondary actions
  static const Color successLight =
      Color(0xFF059669); // Order confirmation and positive states
  static const Color warningLight =
      Color(0xFFD97706); // Inventory alerts and important notices
  static const Color errorLight =
      Color(0xFFDC2626); // Form validation and critical alerts
  static const Color surfaceLight =
      Color(0xFFFFFFFF); // Clean background for product photography
  static const Color surfaceVariantLight =
      Color(0xFFF8FAFC); // Subtle section separation
  ...
  static const Color onSurfaceVariantLight =
      Color(0xFF475569); // Secondary text hierarchy
  static const Color accentLight =
      Color(0xFF7C3AED); // Special promotions, minimal use

  // Dark theme colors maintaining commerce trust patterns
  ...
  static const Color dividerLight = Color(0x1A475569);
  static const Color dividerDark = Color(0x1A94A3B8);
  static const Color shadowLight = Color(0x1A000000);
  static const Color shadowDark = Color(0x1AFFFFFF);

  /// Light theme optimized for mobile commerce
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar theme for mobile commerce header
    ...
    // Card theme with subtle elevation for product cards
    cardTheme: CardTheme(
      color: cardLight,
      elevation: 2.0,
      shadowColor: shadowLight,
    ...
    // Bottom navigation optimized for mobile commerce
    ...
    // FAB for cart access positioned for thumb reach
    ...
    // Button themes optimized for purchase actions
    ...
    switchTheme: SwitchThemeData(
      ...
      trackColor: WidgetStateProperty.resolveWith((states) {
        ...
        return onSurfaceVariantLight.withValues(alpha: 0.2);
      }),
    ),
    ...
    checkboxTheme: CheckboxThemeData(
      ...
      side: BorderSide(color: onSurfaceVariantLight, width: 2.0),
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(4.0),
      ),
    ),

    // Radio theme for product options
    ...
    // Bottom sheet theme for filters and actions
  ...
  /// Dark theme maintaining commerce patterns
  static ThemeData darkTheme = ThemeData(
    ...
    switchTheme: SwitchThemeData(
      ...
      trackColor: WidgetStateProperty.resolveWith((states) {
        ...
        return onSurfaceVariantDark.withValues(alpha: 0.2);
      }),
    ),
    checkboxTheme: CheckboxThemeData(
      fillColor: WidgetStateProperty.resolveWith((states) {
      ...
      checkColor: WidgetStateProperty.all(Colors.white),
      side: BorderSide(color: onSurfaceVariantDark, width: 2.0),
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(4.0),
      ),
    ),
  ...
  /// Helper method to get price text style
